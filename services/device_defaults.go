...
var defaultDeviceGroups = []domains.DeviceGroup{
	...
	{BaseDataEntity: baseData("dic"), Key: "dic", Name: "数据相机", Icon: "experiment", DefaultWebPort: 8885, DefaultDomain: "vpn-dic.navfirst.com", Sort: 60, Remark: "数据相机类设备", Status: int(domains.StatusEnabled)},
